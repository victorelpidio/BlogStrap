class CategoriesController < ApplicationController
  ...
  def destroy
    if @category.destroy
      ...
      redirect_to categories_url, alert: @category.errors.messages[:base][0] # mensagem que nao permite apagar um category com um article dentro([:base][0] = pega a string)
    end
  end
